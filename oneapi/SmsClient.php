...
class SmsClient extends AbstractOneApiClient {
    ...
    public function sendSMS($message) {
        $restPath = '/restapi/1/smsmessaging/outbound/{senderAddress}/requests'; //TODO check version
    ...
    public function queryDeliveryStatus($clientCorrelatorOrResourceReference = null) {
        $restPath = '/restapi/1/smsmessaging/outbound/requests/{clientCorrelator}/deliveryInfos';
    ...
    public function retrieveOutboundMessages($fromTime=null, $toTime=null, $messageId=null){
        ...
        $restUrl = $this->getRestUrl('/restapi/2/messaging/outbound/logs/');
    ...
    public function retrieveInboundMessagesSubscriptions() {
        $restUrl = $this->getRestUrl('/restapi/1/smsmessaging/inbound/subscriptions');
    ...
    public function cancelInboundMessagesSubscription($subscriptionId) {
        $restUrl = $this->getRestUrl('/restapi/1/smsmessaging/outbound/subscriptions/' . $subscriptionId);
    ...
    public function retrieveInboundMessages($maxNumberOfMessages=null){
        $restUrl = $this->getRestUrl('/restapi/1/smsmessaging/inbound/registrations/INBOUND/messages');
    ...
    public function subscribeToDeliveryStatusNotifications($subscribeToDeliveryNotificationsRequest) {
        $restUrl = $this->getRestUrl('/restapi/1/smsmessaging/outbound/'.$subscribeToDeliveryNotificationsRequest->senderAddress.'/subscriptions');
    ...
    public function retrieveDeliveryNotificationsSubscriptions() {
        $restUrl = $this->getRestUrl('/restapi/1/smsmessaging/outbound/subscriptions');
